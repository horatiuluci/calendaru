(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["events-events-module"], {
    ...
    /***/
    function dTK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CreateEventDialogComponent", function () {
        return CreateEventDialogComponent;
      });
      /* harmony import */
      ...
      function CreateEventDialogComponent_mat_error_5_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function CreateEventDialogComponent_mat_error_10_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateEventDialogComponent_mat_error_15_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateEventDialogComponent_mat_error_20_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "mat-error");
      ...
      function CreateEventDialogComponent_mat_option_25_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var CreateEventDialogComponent = /*#__PURE__*/function () {
        function CreateEventDialogComponent(dialogRef, eventsService, formBuilder) {
          _classCallCheck(this, CreateEventDialogComponent);
        ...
        _createClass(CreateEventDialogComponent, [{
          key: "ngOnInit",
          ...
          value: function getOtherUsers() {
            ...
            this.eventsService.getOtherUsersObservable().subscribe(function (data) {
              _this.otherAllowedUsers = data;
            });
          }
        }, {
          key: "createEvent",
          value: function createEvent() {
            ...
            var createdEvent = this.createEventForm.value;
            this.eventsService.createEventObservable(createdEvent).subscribe(function (data) {
      ...
      CreateEventDialogComponent.ɵfac = function CreateEventDialogComponent_Factory(t) {
        return new (t || CreateEventDialogComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_events_service__WEBPACK_IMPORTED_MODULE_3__["EventsService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]));
      };

      CreateEventDialogComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        type: CreateEventDialogComponent,
        selectors: [["app-create-event-dialog"]],
        decls: 29,
        vars: 8,
        consts: [["autocomplete", "off", 3, "formGroup", "ngSubmit"], ["matInput", "", "formControlName", "title", "id", "title", "placeholder", "Title"], [4, "ngIf"], ["matInput", "", "formControlName", "description", "id", "description", "placeholder", "Description"], ["type", "date", "matInput", "", "formControlName", "startDate", "id", "startDate", "placeholder", "Starting date"], ["type", "date", "matInput", "", "formControlName", "endDate", "id", "endDate", "placeholder", "Ending date"], ["appearance", "fill"], ["multiple", "", 3, "formControl"], [3, "value", 4, "ngFor", "ngForOf"], [2, "text-align", "center", "margin-top", "10px"], ["mat-flat-button", "", "color", "primary", "type", "submit", 3, "disabled"], [3, "value"]],
        template: function CreateEventDialogComponent_Template(rf, ctx) {
          if (rf & 1) {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "form", 0);

            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function CreateEventDialogComponent_Template_form_ngSubmit_0_listener() {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](CreateEventDialogComponent, [{
    ...
    /***/
    function QFKT(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _create_event_dialog_create_event_dialog_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./create-event-dialog/create-event-dialog.component */
      "4dTK");
      /* harmony import */
      ...
      var _events_events_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      ...
      function EventsPage_mat_progress_bar_15_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "mat-progress-bar", 17);
        }
      }

      function EventsPage_th_18_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function EventsPage_td_19_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function EventsPage_th_21_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 18);
      ...
      function EventsPage_td_22_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 19);
      ...
      function EventsPage_th_24_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 18);
      ...
      function EventsPage_td_25_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 19);
      ...
      function EventsPage_th_27_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 18);
      ...
      function EventsPage_td_28_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 19);
      ...
      function EventsPage_th_30_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 18);
      ...
      function EventsPage_td_31_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 19);
      ...
      function EventsPage_th_33_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "th", 18);
      ...
      function EventsPage_td_34_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "td", 19);
      ...
      function EventsPage_tr_35_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "tr", 20);
        }
      }

      function EventsPage_tr_36_Template(rf, ctx) {
        if (rf & 1) {
      ...
      var EventsPage = /*#__PURE__*/function () {
        function EventsPage(dialog, authService, eventsService) {
          _classCallCheck(this, EventsPage);

          this.dialog = dialog;
          this.authService = authService;
          this.eventsService = eventsService;
          this.displayedColumns = ['nr', 'title', 'description', 'startDate', 'endDate', 'allowedUsers'];
        ...
        _createClass(EventsPage, [{
          ...
          value: function getEvents() {
            ...
            this.eventsService.getEventsObservable().subscribe(function (data) {
              if (data) {
                var dataToArray = [];
                ...
                _this3.dataSource = dataToArray;
                _this3.isTableLoading = false;
              }
            }, function (error) {
              _this3.isTableLoading = false;
              console.log(error);
          ...
          value: function openDialog() {
            ...
            var dialogRef = this.dialog.open(_create_event_dialog_create_event_dialog_component__WEBPACK_IMPORTED_MODULE_1__["CreateEventDialogComponent"], {
              width: '500px',
              height: '460px'
            });
      ...
      EventsPage.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        decls: 37,
        vars: 4,
        consts: [[1, "my-card"], [2, "text-align", "center"], [2, "margin-top", "10px"], ["mat-flat-button", "", "color", "primary", 3, "click"], ["mat-flat-button", "", "color", "warn", 2, "margin-left", "10px", 3, "click"], ["mode", "indeterminate", "style", "margin: auto; margin-top: 50px;", 4, "ngIf"], ["mat-table", "", 1, "my-table", "mat-elevation-z8", 3, "dataSource"], ["matColumnDef", "nr"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "title"], ["matColumnDef", "description"], ["matColumnDef", "startDate"], ["matColumnDef", "endDate"], ["matColumnDef", "allowedUsers"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["mode", "indeterminate", 2, "margin", "auto", "margin-top", "50px"], ["mat-header-cell", ""], ["mat-cell", ""], ["mat-header-row", ""], ["mat-row", ""]],
        template: function EventsPage_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EventsPage_Template_button_click_11_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function EventsPage_Template_button_click_13_listener() {
              return ctx.logout();
            });
    ...
    function pTcb(module, __webpack_exports__, __webpack_require__) {
      ...
      var _events_routing_module__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./events-routing.module */
      "kE+t");
      /* harmony import */


      var _events_page__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./events.page */
      "QFKT");
      /* harmony import */


      var _create_event_dialog_create_event_dialog_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./create-event-dialog/create-event-dialog.component */
      "4dTK");
      ...
      EventsPageModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
        type: EventsPageModule
      });
      EventsPageModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](EventsPageModule, {
      ...
      (function () {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](EventsPageModule, [{
          type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"],
          args: [{
            imports: [_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ReactiveFormsModule"], _material_module__WEBPACK_IMPORTED_MODULE_3__["MaterialModule"], _events_routing_module__WEBPACK_IMPORTED_MODULE_4__["EventsPageRoutingModule"]],
            declarations: [_events_page__WEBPACK_IMPORTED_MODULE_5__["EventsPage"], _create_event_dialog_create_event_dialog_component__WEBPACK_IMPORTED_MODULE_6__["CreateEventDialogComponent"]],
            entryComponents: [_create_event_dialog_create_event_dialog_component__WEBPACK_IMPORTED_MODULE_6__["CreateEventDialogComponent"]]
          }]
        }], null, null);
      })();
      /***/
    ...
    /***/
    function vOPS(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var EventsService = /*#__PURE__*/function () {
        ...
        _createClass(EventsService, [{
          key: "getOtherUsersObservable",
          value: function getOtherUsersObservable() {
            return this.http.get(_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].apiUrl + '/other-users');
          }
        }, {
          key: "getEventsObservable",
          value: function getEventsObservable() {
          ...
          value: function createEventObservable(createEvent) {
